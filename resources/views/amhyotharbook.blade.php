                ...
                <li>
                  <div class="photo_grid">
                    <figure class="effect-layla"> 
                        @if($b->attach_file!='')
                        <a href="{{route('viewfile',$b->attach_file)}}" target="_blank"> <img src="{{ asset('upload/posts/'.$b->feature_photo) }}" alt="" ></a> 
                        @else
                        <a href="#" > <img src="{{ asset('upload/posts/'.$b->feature_photo) }}" alt="" ></a> 
                        @endif
                    </figure>
                    <h4>{{$b->title}}</h4>
                    <h2>
