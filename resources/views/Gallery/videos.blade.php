  ...
  <div class="col-lg-8 col-md-8 col-sm-8">
    <div class="left_content">
      <div class="single_post_content">
        <h2>ဗီဒီယိုဖိုင္မ်ား</h2>
        <ul class="photograph_nav  wow fadeInDown">
          @foreach($posts as $video)
          <li>
              <div style="margin-bottom: 20px;">
                <p style="margin-left: 15px;">{{$video->title}}</p>
                <video width="240" height="200" controls style="padding-left:10px; margin-top: -35px;" >
                        <source src="{{ asset('upload/posts/'.$video->attach_file) }}" type="video/mp4">
                </video>
              </div>
